...
const styles = StyleSheet.create({
  ...
  tag: { fontSize: fontSize.sm, color: colors.textBlue, marginTop: 40 },
  merchant: { fontSize: fontSize.xxl, fontWeight: '700', color: colors.textPrimary, marginTop: 8, marginBottom: 24 },
  section: { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: colors.divider, paddingVertical: 12 },
  row: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 12 },
  rowLabel: { fontSize: fontSize.md, color: colors.textSecondary },
  rowValue: { fontSize: fontSize.md, color: colors.textPrimary, flexShrink: 1, textAlign: 'right' },
  rowValueBold: { fontWeight: '700' },
  bottomBar: { padding: 16 },
  confirmButton: { backgroundColor: colors.kakaoYellow, borderRadius: 12, paddingVertical: 16, alignItems: 'center' },
  confirmText: { fontSize: fontSize.md, fontWeight: '700', color: colors.textPrimary },
});
